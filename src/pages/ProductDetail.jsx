    ...
    <section>
      <Row>
        ...
        <Col lg={6} className="ps-5">
          <div className="text-bold text-muted mb-3">{product.brand}</div>
          <h3 className="text-small">{product.title}</h3>
          <p>{product.description}</p>
          <Row>
            <Col>
              <span className="text-light text-muted">Price</span>
              <br />
            ...
            <Col>
              <span className="text-light text-muted">Quantity</span>
